...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220409_giadungdoangia_b6e54a4bbf966da76898_20220409032941_archive.zip';
	const ARCHIVE_SIZE		 = '91843058';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b6e54a4-09032941';
    const SECONDARY_PACKAGE_HASH = '4283e7d-09032941';
	const VERSION			 = '1.4.4';
